...
() {
  ...
  function p10k-on-post-prompt() { p10k display '1|2/left/prompt_char|*/left_frame'=hide '2/left/example'=show }
  function p10k-on-pre-prompt()  { p10k display '1|2/left/prompt_char'=show '2/left/example|2/right/*|*/left_frame'=hide }
