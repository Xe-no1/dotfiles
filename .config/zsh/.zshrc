...
autoload -Uz $ZDOTDIR/functions/plugin-load
autoload -Uz $ZDOTDIR/functions/zcompile-many
autoload -Uz $ZDOTDIR/functions/plugin-clean
autoload -Uz $ZDOTDIR/functions/plugin-update
autoload -Uz $ZDOTDIR/functions/addText
...
[[ $ZDOTDIR/functions/plugin-load.zwc -nt $ZDOTDIR/functions/plugin-load ]] || zcompile-many $ZDOTDIR/functions/plugin-load
[[ $ZDOTDIR/functions/plugin-clean.zwc -nt $ZDOTDIR/functions/plugin-clean ]] || zcompile-many $ZDOTDIR/functions/plugin-clean
[[ $ZDOTDIR/functions/plugin-update.zwc -nt $ZDOTDIR/functions/plugin-update ]] || zcompile-many $ZDOTDIR/functions/plugin-update
[[ $ZDOTDIR/functions/zcompile-many.zwc -nt $ZDOTDIR/functions/zcompile-many ]] || zcompile-many $ZDOTDIR/functions/zcompile-many
[[ $ZDOTDIR/functions/addText.zwc -nt $ZDOTDIR/functions/addText ]] || zcompile-many $ZDOTDIR/functions/addText
...
export FZF_DEFAULT_OPTS=$FZF_DEFAULT_OPTS'
  ...
  --bind=ctrl-y:accept,ctrl-e:abort,ctrl-k:kill-line
  --bind=esc:unbind[esc],enter:unbind[enter],ctrl-c:unbind[ctrl-c],ctrl-g:unbind[ctrl-g],ctrl-q:unbind[ctrl-q]'
