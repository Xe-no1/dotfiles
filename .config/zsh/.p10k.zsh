...
() {
  ...
  # Basic style options that define the overall look of your prompt. You probably don't want to change them.
  ...
  # The default icon shown next to non-writable and non-existent directories when POWERLEVEL9K_DIR_SHOW_WRITABLE is set to v3.
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_BACKGROUND=#2E3440
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=#2E3440
