...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/mazentech/.rbenv/versions/3.3.5")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/mazentech/.rbenv/versions/3.3.5' '--with-openssl-dir=/opt/homebrew/opt/openssl@3' '--enable-shared' '--with-libyaml-dir=/opt/homebrew/opt/libyaml' '--with-gmp-dir=/opt/homebrew/opt/gmp' '--with-ext=openssl,psych,+' 'CC=clang'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/mazentech/.rbenv/versions/3.3.5"
